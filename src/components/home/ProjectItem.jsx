...
export default function ProjectItem({ title, year, services, index }) {
    ...
    >
      ...
      <div className="flex items-center justify-between px-8 z-10">
        <motion.div variants={textVariants} className="flex items-baseline gap-4">
          ...
          <h3 className="text-5xl md:text-7xl font-black uppercase tracking-tighter text-white mix-blend-difference">
            {title}
          </h3>
        </motion.div>
      ...
      <motion.div
        className="px-8 mt-6 flex items-center justify-between z-10"
