    ...
    <div className="w-full h-full bg-neutral-900/50 flex flex-col font-sans relative overflow-hidden">
      ...
      <div className="p-6 flex justify-between items-center border-b border-white/5">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-white text-[10px] font-bold tracking-widest uppercase font-mono">
            System.Reaction_Test
          </h2>
        </div>
        {bestScore && (
          <div className="flex items-center gap-2">
        ...
        <AnimatePresence mode="wait">
          {gameState === "idle" && (
            ...
            >
              ...
              <span className="text-neutral-400 text-[10px] uppercase tracking-[0.4em] font-mono">
                Initialize Test
              </span>
            </motion.div>
          )}
          ...
          {gameState === "waiting" && (
            <motion.div
              ...
              className="text-center"
            >
              <span className="text-neutral-500 text-[10px] uppercase tracking-[0.5em] font-mono animate-pulse">
                Scanning...
              </span>
            </motion.div>
          )}
          ...
          {gameState === "playing" && (
            <motion.div
              ...
              className="text-center"
            >
              <span className="text-orange-500 text-4xl font-black uppercase tracking-[0.3em]">
                TRIGGER
              </span>
            </motion.div>
          )}
          ...
          {gameState === "result" && (
            ...
            >
              <div
                className={`text-7xl md:text-9xl font-black tracking-tighter mb-8 ${typeof score === "number" ? "text-white" : "text-red-500"}`}
              >
