      ...
      <div className="w-full flex flex-col md:flex-row h-[75vh] min-h-[500px] md:h-[600px] border border-neutral-800 bg-neutral-900/50 rounded-lg overflow-hidden font-sans">
        ...
        >
          ...
          <div className="absolute inset-0 z-30 pointer-events-none flex items-center justify-between px-2 md:hidden">
            <button onClick={handlePrev} className="pointer-events-auto p-3 bg-black/50 backdrop-blur-md rounded-full border border-white/10 text-white hover:bg-orange-500 active:scale-95 transition-all">
            ...
            <button onClick={handleNext} className="pointer-events-auto p-3 bg-black/50 backdrop-blur-md rounded-full border border-white/10 text-white hover:bg-orange-500 active:scale-95 transition-all">
              ...
              <div className="relative inline-block max-w-full max-h-full">
                ...
                <div className="absolute bottom-3 left-3 bg-black/75 backdrop-blur-md border border-white/10 px-3 py-2 rounded-md font-mono text-[9px] text-neutral-300 shadow-lg z-20 pointer-events-none max-w-[calc(100%-24px)]">
                  ...
                  <div className="text-neutral-500 flex items-center gap-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-3 h-3 opacity-70 shrink-0"><path fillRule="evenodd" d="M9.69 18.933l.003.001C9.89 19.02 10 19 10 19s.11.02.308-.066l.002-.001.006-.003.018-.008a5.741 5.741 0 00.281-.14c.186-.096.446-.24.757-.433.62-.384 1.445-.966 2.274-1.765C15.302 14.988 17 12.493 17 9A7 7 0 103 9c0 3.493 1.698 5.988 3.355 7.584a13.731 13.731 0 002.273 1.765 11.842 11.842 0 00.976.544l.062.029.018.008.006.003zM10 11.25a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5z" clipRule="evenodd" /></svg>
